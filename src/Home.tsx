...
const generalInformation: Array<FaqProps> = [
  ...
  },
  {
      ...
      answer: (
          <Typography variant="body1">
              Just set up a standing order for £12 a month to our bank account, and we'll take care of the rest.
          </Typography>
      ),
  },
  {
  ...
  },
  {
      ...
      answer: (
          <Typography variant="body1">
            Nope. Unlike many other website providers we beleive there should be no lengthly contract requirements. 
          </Typography>
      ),
  },
  {
    ...
    answer: (
        <Typography variant="body1">
          You may ask us to change wording, pictures and prices - but beyond nothing else can be changes. We aim to keep things as simple as possible.
          if you wish to have more configration, this service may not be for you.
        </Typography>
    ),
  },
  {
...
export const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          {`Web4All - no easier way for your business to have a website. Just £${price} a
          month.`}
        </title>
